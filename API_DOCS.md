...
## Base URL
`https://image-host.bhootbdmail.workers.dev/`
...
```bash
curl -X POST https://image-host.bhootbdmail.workers.dev/api/v1/upload \
...
```json
{
  ...
  "image": {
    "id": "abc123xy",
    "url": "https://image-host-axg.pages.dev/i/abc123xy.png",
